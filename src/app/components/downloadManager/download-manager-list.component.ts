...
export class DownloadManagerListComponent implements OnInit {
	...
	private downloadManagerFriendlyNameInput: string = '';
	...
	register() {
		this.downloadManagerService
			.registerDownloadManager(this.downloadManagerFriendlyNameInput)
			.subscribe(
	...
	private isValidForm() {
		return (this.downloadManagerFriendlyNameInput);
	}
